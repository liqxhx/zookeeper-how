...
public class CreateNodeSyncAuth implements Watcher { 
	...
	private void doSomething(){
		try {
			...
			ACL aclDigest = new ACL(Perms.READ|Perms.WRITE,new Id("digest",DigestAuthenticationProvider.generateDigest("lqh:123456")));
			ArrayList<ACL> acls = new ArrayList<ACL>();
			acls.add(aclDigest);
			acls.add(aclIp);
			//zookeeper.addAuthInfo("digest", "lqh:123456".getBytes());
			String path = zookeeper.create("/digest", "123".getBytes(), acls, CreateMode.PERSISTENT);
